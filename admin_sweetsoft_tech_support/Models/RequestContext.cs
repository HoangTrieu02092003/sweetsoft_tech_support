...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-4H9FIL3\\SQLEXPRESS;Initial Catalog=Request;Integrated Security=True;Encrypt=True;Trust Server Certificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<TblActivityLog>(entity =>
        {
            entity.HasKey(e => e.ActivityId).HasName("PK__TblActiv__482FBD631D628754");
            ...
            entity.HasOne(d => d.Request).WithMany(p => p.TblActivityLogs)
                ...
                .HasConstraintName("FK__TblActivi__reque__0D7A0286");

            entity.HasOne(d => d.User).WithMany(p => p.TblActivityLogs)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("FK__TblActivi__user___0E6E26BF");
        });

        modelBuilder.Entity<TblAuditLog>(entity =>
        {
            entity.HasKey(e => e.AuditId).HasName("PK__TblAudit__5AF33E338B959901");
            ...
            entity.HasOne(d => d.ChangedByNavigation).WithMany(p => p.TblAuditLogs)
                ...
                .HasConstraintName("FK__TblAuditL__chang__66603565");
        });

        modelBuilder.Entity<TblCustomer>(entity =>
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__TblCusto__CD65CB85C5D06270");

            entity.HasIndex(e => e.Email, "UQ__TblCusto__AB6E6164B0829C97").IsUnique();

            entity.HasIndex(e => e.Username, "UQ__TblCusto__F3DBC5725717B206").IsUnique();
            ...
            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.TblCustomerCreatedByNavigations)
                ...
                .HasConstraintName("FK__TblCustom__creat__6FE99F9F");

            entity.HasOne(d => d.UpdatedByNavigation).WithMany(p => p.TblCustomerUpdatedByNavigations)
                .HasForeignKey(d => d.UpdatedBy)
                .HasConstraintName("FK__TblCustom__updat__70DDC3D8");
        });

        modelBuilder.Entity<TblDepartment>(entity =>
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__TblDepar__C2232422136D3BAE");
        ...
        {
            entity.HasKey(e => e.FaqId).HasName("PK__TblFaqs__66734BAF6869A25F");
        ...
        {
            entity.HasKey(e => e.LogId).HasName("PK__TblLogs__9E2397E06CB752E8");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.TblLogs)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("FK__TblLogs__user_id__628FA481");
        });

        modelBuilder.Entity<TblNotification>(entity =>
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__TblNotif__E059842FAD557268");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.TblNotifications)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("FK__TblNotifi__user___09A971A2");
        });

        modelBuilder.Entity<TblPermission>(entity =>
        {
            entity.HasKey(e => e.PermissionId).HasName("PK__TblPermi__E5331AFA250ECDAD");
        ...
        {
            entity.HasKey(e => e.TransferId).HasName("PK__TblReque__78E6FD335A68F5DC");
        ...
        modelBuilder.Entity<TblRequestsProcessing>(entity =>
        {
            ...
            entity.HasOne(d => d.Department).WithMany(p => p.TblRequestsProcessings)
                ...
                .HasConstraintName("FK__TblReques__depar__02084FDA");

            entity.HasOne(d => d.Request).WithMany(p => p.TblRequestsProcessings)
                .HasForeignKey(d => d.RequestId)
                .HasConstraintName("FK__TblReques__reque__01142BA1");
        });

        modelBuilder.Entity<TblRole>(entity =>
        {
            entity.HasKey(e => e.RoleId).HasName("PK__TblRoles__760965CC6BB029B3");
        ...
        {
            entity.HasKey(e => e.RolePermissionId).HasName("PK__TblRole___B1E85A10639E2024");
            ...
            entity.HasOne(d => d.Permission).WithMany(p => p.TblRolePermissions)
                ...
                .HasConstraintName("FK__TblRole_P__permi__5AEE82B9");

            entity.HasOne(d => d.Role).WithMany(p => p.TblRolePermissions)
                .HasForeignKey(d => d.RoleId)
                .HasConstraintName("FK__TblRole_P__role___59FA5E80");
        });

        modelBuilder.Entity<TblSession>(entity =>
        {
            entity.HasKey(e => e.SessionId).HasName("PK__TblSessi__69B13FDCC77F0191");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.TblSessions)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("FK__TblSessio__user___6A30C649");
        });

        modelBuilder.Entity<TblSupportRequest>(entity =>
        {
            entity.HasKey(e => e.RequestId).HasName("PK__TblSuppo__18D3B90FB1FDF481");
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.TblSupportRequests)
                ...
                .HasConstraintName("FK__TblSuppor__custo__74AE54BC");

            entity.HasOne(d => d.Department).WithMany(p => p.TblSupportRequests)
                .HasForeignKey(d => d.DepartmentId)
                .HasConstraintName("FK__TblSuppor__depar__75A278F5");
        });

        modelBuilder.Entity<TblUser>(entity =>
        {
            entity.HasKey(e => e.UserId).HasName("PK__TblUsers__B9BE370FA88C230B");

            entity.HasIndex(e => e.Email, "UQ__TblUsers__AB6E61646E3C0F21").IsUnique();

            entity.HasIndex(e => e.Username, "UQ__TblUsers__F3DBC57286D8FAE6").IsUnique();
            ...
            entity.HasOne(d => d.CreatedUserNavigation).WithMany(p => p.InverseCreatedUserNavigation)
                ...
                .HasConstraintName("FK__TblUsers__create__5629CD9C");

            entity.HasOne(d => d.Department).WithMany(p => p.TblUsers)
                .HasForeignKey(d => d.DepartmentId)
                .HasConstraintName("FK__TblUsers__depart__5535A963");

            entity.HasOne(d => d.Role).WithMany(p => p.TblUsers)
                .HasForeignKey(d => d.RoleId)
                .HasConstraintName("FK__TblUsers__role_i__5441852A");

            entity.HasOne(d => d.UpdatedUserNavigation).WithMany(p => p.InverseUpdatedUserNavigation)
                .HasForeignKey(d => d.UpdatedUser)
                .HasConstraintName("FK__TblUsers__update__571DF1D5");
        });

        modelBuilder.Entity<TblUserPermission>(entity =>
        {
            entity.HasKey(e => e.UserPermissionId).HasName("PK__TblUser___D98F48193FED31B1");
            ...
            entity.HasOne(d => d.Permission).WithMany(p => p.TblUserPermissions)
                .HasForeignKey(d => d.PermissionId)
                .HasConstraintName("FK__TblUser_P__permi__5EBF139D");

            entity.HasOne(d => d.User).WithMany(p => p.TblUserPermissions)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("FK__TblUser_P__user___5DCAEF64");
        });
